            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1 style={{ height: "8rem", color: "white" }}>{`Hi! I'm Nitin Sahu`} <br /><span className="txt-rotate" dataPeriod="1000" data-rotate='["React Developer" ,"Web Developer", "Web Designer", "MERN STACK DEVELOPER" ]'><span className="wrap">{text}</span></span></h1>
                  <p>Seeking a challenging MERN stack developer position
                    where my expertise in MongoDB, Express.js, React, and Node.js
                    can be leveraged to develop innovative, scalable, and user-centric
